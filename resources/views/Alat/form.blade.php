                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="select-style-1">
                                        ...
                                        <div class="select-position">
                                            <select class="select2" value="{{old('JenisAlatBeratId')}}" name="JenisAlatBeratId" id="JenisAlatBeratId" style="width: 100%">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" placeholder="Masukkan Nama Merek Alat Berat" class="form-control @error('Merk') is-invalid @enderror" name="Merk" value="{{old('Merk')}}" required />
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" placeholder="Masukkan Nomor Seri Alat Berat" class="form-control @error('NoSeri') is-invalid @enderror" name="NoSeri" value="{{old('NoSeri')}}" required />
                                ...
                                <div class="col-sm-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" placeholder="Masukkan Nama Model Alat Berat" class="form-control @error('NamaModel') is-invalid @enderror" name="NamaModel" value="{{old('NamaModel')}}" required />
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-style-1 mt-4">
                                        ...
                                        <input type="file" class="form-control @error('Foto') is-invalid @enderror" id="FotoAlatBerat" name="Foto" accept=".png, .jpg, .jpeg" value="{{old('Foto')}}" />
                                        @error('NoSeri') <span class="text-danger">{{$message}}</span> @enderror
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="month" placeholder="Masukkan Tahun Perolehan Alat Berat" class="form-control @error('TahunPerolehan') is-invalid @enderror" name="TahunPerolehan" value="{{old('TahunPerolehan')}}" required />
                                    ...
                                    <div class="select-style-1">
                                        ...
                                        <div class="select-position">
                                            <select class="select" value="{{old('Keterangan')}}" name="Keterangan" id="Keterangan" style="width: 100%">
                                                <option value="-" selected disabled> Pilih Keterangan Alat Berat </option>
                                                <option value="0">Beroperasi</option>
                                                <option value="1">Beroperasi segera dilakukan perbaikan</option>
                                                <option value="2">Breakdown/dapat dilakukan perbaikan</option>
                                                <option value="3">Breakdown/rusak berat</option>
                                            </select>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="select-sm select-style-1">
                                        ...
                                        <div class="select-position input-tags">
                                            <select class="js-example-basic-single form-" value="{{old('Kondisi')}}" id="tags" multiple name="Kondisi[]">
                                                @foreach($kondisi as $value)
                                                <option value="<?= $value->KondisiId ?>"><?= $value->Label ?></option>
                                                @endforeach
                                            </select>
