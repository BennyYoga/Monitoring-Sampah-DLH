                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-style mb-30">
                        ...
                        <div class="input-style-1 col-lg-6">
                            ...
                            <input type="text" placeholder="Nama Lengkap" id="nama_pegawai" name="nama_pegawai" required autofocus value="{{$pegawai->nama_pegawai}}"/>
                        </div>
                        <!-- end input -->
                        <div class="input-style-1 col-lg-6">
                            <label>NIP</label>
                            <input type="number" placeholder="NIP" id="NIP" name="NIP" required autofocus value="{{$pegawai->NIP}}"/>
                        </div>
                        <!-- end input -->
                        </div>
                        <!-- end row -->
