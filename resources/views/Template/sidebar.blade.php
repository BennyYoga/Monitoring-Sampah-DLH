    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-item nav-item-has-children {{ (Request::routeIs('alat.*') or Request::routeIs('jenisalat.*') or Request::routeIs('kondisialat.*')) ? 'active' : '' }}">
                <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu" aria-controls="ddmenu" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                ...
                <ul id="ddmenu" class="collapse dropdown-nav {{ (Request::routeIs('alat.*') or Request::routeIs('jenisalat.*') or Request::routeIs('kondisialat.*')) ? 'show' : '' }}">
                    <li>
		...
		c3.6,0,6.6-2.7,7-6.3l2.5-21.8c1.6-0.2,2.9-1.6,2.9-3.2v-8.2C59.7,21,58.2,19.6,56.4,19.6z M8.8,24.1h46.4v5.7H8.8V24.1z
		 M47.3,57.8H16.7c-1.3,0-2.4-1-2.6-2.3l-2.4-21.2h40.6l-2.4,21.2C49.7,56.8,48.6,57.8,47.3,57.8z" />
                ...
                <ul id="ddmenu_1" class="collapse dropdown-nav {{ (Request::routeIs('aset.*')) ? 'show' : '' }}">
                    <li>
