...
@section('title','Trash Monitoring System | Create Kantor')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-style mb-30">
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Nama kantor" name="nama_kantor"/>
                        </div>
                        <!-- end input -->
                        <div class="input-style-1">
                            <label>Alamat</label>
                            <input type="text" placeholder="Alamat kantor" name="alamat_kantor"/>
                        </div>
                        <!-- end input -->
